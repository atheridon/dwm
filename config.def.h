...
static const char *dmenucmd_nocol[] = { "dmenu_run", "-fn", dmenufont, "-nb", dmenubg, "-p", dmenuprompt, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_d,      spawn,          {.v = dmenucmd_nocol } },
	...
	{ MODKEY|Mod4Mask,              XK_h,      incrgaps,       {.i = +10 } },
	{ MODKEY|Mod4Mask,              XK_l,      incrgaps,       {.i = -10 } },
